                ...
                <div class="card-body p-5">
                    ...
                    <form method="POST" action="/Category/update">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="name" class="form-control" value="<?php echo htmlspecialchars($category->name); ?>" required style="border-radius: 12px; padding: 12px;">
                        </div>
                        <div class="mb-4">
                            <label class="form-label fw-bold">Mô tả đặc điểm</label>
                            <textarea name="description" class="form-control" rows="3" required style="border-radius: 12px; padding: 12px;"><?php echo htmlspecialchars($category->description); ?></textarea>
                        </div>
